...
generateFlatB1('b1_clt_tse.mnc', 1, 'b1_nominal.mnc');
%% Fit T1 maps
%
...
fitDataVFA_es (subjectID, gre_vfaID, 'b1_bic_tse.mnc', 't1_gre_vfa_b1_bic_tse', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 

fitDataVFA_es (subjectID, gre_vfaID, 'b1_nominal.mnc', 't1_gre_vfa_b1_nominal', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 
...
fitDataVFA_es (subjectID, clt_vfaID, 'b1_bic_tse.mnc', 't1_clt_vfa_b1_bic_tse', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 

fitDataVFA_es (subjectID, clt_vfaID, 'b1_nominal.mnc', 't1_clt_vfa_b1_nominal', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 
...
fitDataVFA_es (subjectID, clt_vfa_spoilID, 'b1_bic_tse.mnc', 't1_clt_vfa_spoil_b1_bic_tse', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 

fitDataVFA_es (subjectID, clt_vfa_spoilID, 'b1_nominal.mnc', 't1_clt_vfa_spoil_b1_nominal', [subjectID, '_', num2str(structID), '_mri_reg_resamp_es.mnc']) 
...
system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_es_2x2x5.mnc t1/t1_gre_vfa_b1_bic_tse.mnc t1/temp.mnc')
system('rm t1/t1_gre_vfa_b1_bic_tse.mnc')
system('mv t1/temp.mnc t1/t1_gre_vfa_b1_bic_tse.mnc')

system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_es_2x2x5.mnc t1/t1_gre_vfa_b1_nominal.mnc t1/temp.mnc')
system('rm t1/t1_gre_vfa_b1_nominal.mnc')
system('mv t1/temp.mnc t1/t1_gre_vfa_b1_nominal.mnc')
...
system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_es_2x2x5.mnc t1/t1_clt_vfa_spoil_b1_bic_tse.mnc t1/temp.mnc')
system('rm t1/t1_clt_vfa_spoil_b1_bic_tse.mnc')
system('mv t1/temp.mnc t1/t1_clt_vfa_spoil_b1_bic_tse.mnc')

system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_es_2x2x5.mnc t1/t1_clt_vfa_spoil_b1_nominal.mnc t1/temp.mnc')
system('rm t1/t1_clt_vfa_spoil_b1_nominal.mnc')
system('mv t1/temp.mnc t1/t1_clt_vfa_spoil_b1_nominal.mnc')
...
system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_ll_2x2x5.mnc b1/b1_bic_tse.mnc b1/temp.mnc')
system('mv b1/temp.mnc b1/b1_bic_tse.mnc')

system('minccalc -expression ''abs(A[0]-1)<0.001?A[1]:0'' mask/brain_wm_mask_resamp_ll_2x2x5.mnc b1/b1_nominal.mnc b1/temp.mnc')
system('mv b1/temp.mnc b1/b1_nominal.mnc')
